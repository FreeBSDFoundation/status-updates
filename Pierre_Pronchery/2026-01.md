...
## **Reporting Period:** 2026-01-05 - 2026-01-23
...
* Imported spdxtool from pkgconf into the base system (reviews needed of the
  [vendor import](https://github.com/khorben/freebsd-src/tree/vendor/pkgconf)
  and [spdxtool
  import](https://github.com/khorben/freebsd-src/tree/khorben/spdxtool) branches)
...
* Requesting a review for the import of spdxtool via pkgconf into the base
  system
