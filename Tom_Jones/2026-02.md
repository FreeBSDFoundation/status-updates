...
## **Reporting Period:** 2026-02-24 - 2025-03-03
...
- Complete and submit article on how the console sub system works
- Start writing a framework for a wifi test suite
...
- Draft an article on how the console sub system works
- update code reviews
...
- [ ] extend perfetto with freebsd providers for:
    ...
    Complete a proof of concept of a dtrace provider for perfetto. This can
    take fbt and kinst probes and will plot them correctly. There is smooting
    of the interface needed an we need to still define a clock, but this is
    minimally usable now.
...
#### **Ongoing Tasks**
- [ ] Test loader support
   Worked through a round of code review 
- [ ] Test kernel support
- [ ] Track down stall in host mode driver

#### **Completeed tasks **

- [x] xhci debug adapters
    I built out 3 more boards on a hunch I knew the answer to why they were not
    functioning. I think the issue is with how usb3 does device detection. It
    measure the rc circuit on the tx lines to discover an open circuit and when
    it is connected. When a device is connected the rc circuit differs. I
    suspect the adapters are taking the usb3 cable out of spec enough that it
    is not detected.
