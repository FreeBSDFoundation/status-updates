...
## **Reporting Period:** 2026-01-27 - 2025-02-03
...
- [ ] extend perfetto with freebsd providers for:
    ...
    I have started writing a dtrace perfetto provider
...
- [x] build and test DAM board
- [x] build and test xhci debug board
- [x] rebase xhci debug changes up to end of Jan.
