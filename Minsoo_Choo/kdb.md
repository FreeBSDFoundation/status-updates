...
This is simply a wrapper script that can trigger lldb for kernel debuggin like we trigger kgdb. There are three options that won't be included in `kdb(1)`.

- `-q`: lldb doesn't print copyright notice like gdb does.
