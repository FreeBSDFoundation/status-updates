...
## **Reporting Period:** 2026-01-28 - 2025-02-03
...
- Replicate upgrade on the [staging environment](https://reviews-dev.freebsd.org)
#### **Features Delivered**
#### **Challenges**
#### **Blockers**
#### **Next Steps**
- Li-wen will do this on production when he has time. Since I finished my part, I'm marking this as completed.
#### **Open Questions and Discussion**
...
#### **Next Steps**
 ...
 - Add sysctl for `hmp` framework so users can check cpucap status and capability and score per core.
