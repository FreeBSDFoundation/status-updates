...
- MFCs to stable/15.
- sound: Retire snd_mixer->busy: https://cgit.freebsd.org/src/commit/?id=e5d50a679aa1a72a7cbcb0281b9420aad4a7dc7a

#### Ongoing Tasks

- snd_hdsp*: Fix M_NOWAIT malloc(9) calls: https://reviews.freebsd.org/D53896
- [PR 290462](https://bugs.freebsd.org/bugzilla/show_bug.cgi?id=290462)

#### Code Reviews

- sound examples: Fix buffer mapping/allocation: https://reviews.freebsd.org/D53939
...
## **Reporting Period:** 2025-11-18 - 2025-11-24
...
- Several MFCs to stable/15.
- sound: Fix KASSERT panics in chn_read() and chn_write(): https://cgit.freebsd.org/src/commit/?id=253b98f749cf93a9a682f46925c43cbbd04e1110
- sound: Remove vchan_passthrough() and hw.snd.passthrough_verbose: https://cgit.freebsd.org/src/commit/?id=3612ef642f511a1bd9f759da87abeafe7d6ff110
- sound: Simplify logic in dsp_io_ops(): https://cgit.freebsd.org/src/commit/?id=b4c32d67d40a862620aa3e565ed0cb9ad59f1e60
- sound: Clean up midi/ includes: https://cgit.freebsd.org/src/commit/?id=4e8eb778803a8bffd0faa507ae2662725363cae5
- sound: Merge PCM_ALIVE() with PCM_REGISTERED(): https://cgit.freebsd.org/src/commit/?id=3107b952f534813846e4f58afdb57624a81618d8
- sound: Merge chn_intr() with chn_intr_locked(): https://cgit.freebsd.org/src/commit/?id=e254ef87a30bfcaabc6e4d8e0ecf05f6949a4f06
	- Ended up reverting it: https://cgit.freebsd.org/src/commit/?id=5cc34a83e1cc812871fd02a15b7d9f75342faaa0
- sound: Retire snd_mtx* wrappers: https://cgit.freebsd.org/src/commit/?id=9d18115ca0ab0ef3f34173d4e2bdabec916d0b60
	- arm: Add missing argument in mtx_init() calls: https://cgit.freebsd.org/src/commit/?id=120f8a4c2ae8a011827d83b098ecf70c791f794b
- sound: Fix revents in midi_poll(): https://cgit.freebsd.org/src/commit/?id=8f8b8e4af91d4e158caf6ba4b728482311bfc7c3
...
- sound: Retire snd_mixer->busy: https://reviews.freebsd.org/D53859
- snd_hdsp*: Fix M_NOWAIT malloc(9) calls: https://reviews.freebsd.org/D53896
...
- Clarify MPU-401 init: https://github.com/freebsd/freebsd-src/pull/1892
- beep: Sort usage and man page options: https://reviews.freebsd.org/D53827
