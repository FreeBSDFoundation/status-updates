...
- [x] Got firmware fully loading and within a good hour a bit had
      scanning and some packets working.
	This required changes (see Blockers)
- [x] Filled in more LinuxKPI skeleton functions to get rid of TODOs
- [x] I have short-circuit some TX routines and packets are flowing.
	This requires further work shared with rtw8x (see Next Steps)

#### **Next Steps**

- [ ] Upstream as much code as possible.
- [ ] Debug and improve the TX queuing routines also used by rtw8x as
      currently frames are not dequeued by the mt76 drivers and thus
      EAPOL is never completed and TX would seem to not work if checked
      by a monitor node.
- [ ] Test my newly arrived MT7925 card as well.
...
- [ ] Deal with various iwlwifi(4) related problem reports.
...
- [ ] MFCs
- [ ] Commit apprently helpful fixes
